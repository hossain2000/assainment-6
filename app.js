...
const firstClassMinusBtn = document.querySelector('.second-minas');
const firstClassPlusBtn = document.querySelector('.second-plus');
const firstClassTicket = document.querySelector('#duration');
